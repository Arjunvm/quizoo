...
function getConnection() {
	...
	global $db_quizoo_db_Url, $db_quizoo_db_User, $db_quizoo_db_Pass, $db_quizoo_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_quizoo_db_Url.";dbname=".$db_quizoo_db_DbName, $db_quizoo_db_User, $db_quizoo_db_Pass);
